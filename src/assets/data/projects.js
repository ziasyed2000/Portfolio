...
const projects = [
  {
    ...
    name: 'Banker',
    desc:
      'ATM inspired banking app made to manage individual accounts and transfers. Security implementation with automation logout timer and logic based loan requests based on past balance history. Created using Javascript, HTML/CSS.',
    img: banker,
  ...
  },
  {
    ...
    desc:
      'Real time Object detection using the camera to interpret Sign Language and display the message on-screen with object tracking by pulling Pre-trained object models from AWS S3. Created using ReactJS, TensorFlowJS & Python Models.',
    img: signLang,
